...
final class GeneralSettings: ObservableObject {
    ...
    /// A Boolean value that indicates whether the Veil icon
    /// should be shown.
    ...
    /// The last user-selected custom Veil icon.
    ...
    /// A Boolean value that indicates whether to use the Veil Bar
    ...
    /// The location where the Veil Bar appears.
    @Published var iceBarLocation = Defaults.DefaultValue.iceBarLocation

    /// A Boolean value that indicates whether the Veil Bar should
