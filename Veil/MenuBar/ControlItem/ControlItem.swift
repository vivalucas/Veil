...
final class ControlItem {
    ...
    /// Hides the Veil icon without removing the status item or losing autosave data.
    ...
    private func createMenu(with appState: AppState) -> NSMenu {
        ...
        settingsItem.image = NSImage(
            ...
            accessibilityDescription: String(localized: "Settings")
        )
        ...
        if !profileManager.profiles.isEmpty {
            ...
            profilesItem.image = NSImage(
                ...
                accessibilityDescription: String(localized: "Profiles")
            )
        ...
        quitItem.image = NSImage(
            ...
            accessibilityDescription: String(localized: "Quit")
        )
        ...
        restartItem.image = NSImage(
            systemSymbolName: "arrow.counterclockwise",
            accessibilityDescription: String(localized: "Restart")
        )
