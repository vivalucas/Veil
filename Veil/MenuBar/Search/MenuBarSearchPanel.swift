        ...
        mainContent
            ...
            .background(
                RoundedRectangle(cornerRadius: 16, style: .continuous)
                    .fill(Color(red: 0.92, green: 0.98, blue: 1.0).opacity(0.18))
            )
            .glassEffect(.regular, in: RoundedRectangle(cornerRadius: 16, style: .continuous))
            .overlay(
                RoundedRectangle(cornerRadius: 16, style: .continuous)
                    .strokeBorder(Color(red: 0.65, green: 0.86, blue: 1.0).opacity(0.36), lineWidth: 1.0)
            )
    ...
    private var labelIcon: some View {
        if let appIcon {
            ...
            RoundedRectangle(cornerRadius: 5)
                .fill(
                    LinearGradient(
                        colors: [Color.white.opacity(0.82), Color.accentColor.opacity(0.58)],
