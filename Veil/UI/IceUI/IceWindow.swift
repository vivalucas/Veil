...
/// A custom scene representing one of Veil's windows.
...
/// Custom identifier constants used to create Veil's windows.
...
extension OpenWindowAction {
    ...
    ///
    /// - Parameter id: An identifier for one of Veil's windows.
