...
final class SettingsURIHandlerTests: XCTestCase {
    ...
    // MARK: - Callback Scheme Validation

    func testCallbackSchemeAllowsCustomAppSchemes() {
        XCTAssertTrue(SettingsURIHandler.isAllowedCallbackScheme("droppy"))
        XCTAssertTrue(SettingsURIHandler.isAllowedCallbackScheme("my-app+callback"))
        XCTAssertTrue(SettingsURIHandler.isAllowedCallbackScheme("MYAPP"))
    }

    func testCallbackSchemeRejectsNetworkAndSystemSchemes() {
        XCTAssertFalse(SettingsURIHandler.isAllowedCallbackScheme("http"))
        XCTAssertFalse(SettingsURIHandler.isAllowedCallbackScheme("https"))
        XCTAssertFalse(SettingsURIHandler.isAllowedCallbackScheme("veil"))
        XCTAssertFalse(SettingsURIHandler.isAllowedCallbackScheme("x-apple.systempreferences"))
    }

    func testCallbackSchemeRejectsInvalidSchemes() {
        XCTAssertFalse(SettingsURIHandler.isAllowedCallbackScheme(""))
        XCTAssertFalse(SettingsURIHandler.isAllowedCallbackScheme("1bad"))
        XCTAssertFalse(SettingsURIHandler.isAllowedCallbackScheme("bad scheme"))
    }
}
